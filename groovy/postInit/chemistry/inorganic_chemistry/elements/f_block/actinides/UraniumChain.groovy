...
MIXER.recipeBuilder()
    ...
    ION_EXCHANGE.recipeBuilder()
        .inputs(metaitem('beads.strong_basic_anion_exchange_resin'))
        .fluidInputs(fluid('pitchblende_leach') * 5400)
        .fluidInputs(fluid('sulfuric_acid') * 6000)
        .outputs(metaitem('beads.loaded_uranium_ion_exchange'))
    ...
    CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('uranyl_sulfate_solution') * 1000)
        .fluidOutputs(fluid('uranium_extract') * 3000)
        .fluidOutputs(fluid('wastewater') * 1000)
        .EUt(240)
        .duration(200)
